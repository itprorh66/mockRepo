...
class SiteLoad(DataFrame):
    ...
    def __init__(self, df_fields, df_field_types, master= None):
        self.master = master
#        DataFrame.__init__(self,   sp.load_fields, sp.load_field_types)
#       Altered for purposes of testing save/import changes
        DataFrame.__init__(self,   df_fields,  df_field_types)
